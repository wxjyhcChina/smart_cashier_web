...
@section ('title', trans('labels.backend.restaurant.management') . ' | ' . trans('labels.backend.restaurant.assignDevice'))
...
@section('content')
    {{ Form::model($restaurant, ['route' => ['admin.restaurant.assignDeviceStore', $restaurant], 'class' => 'form-horizontal', 'id'=>'assign_card_form', 'role' => 'form', 'method' => 'post']) }}
    ...
    <script>
        $(function() {
            var table = $('#card-table').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route("admin.restaurant.getDevices") }}',
                    type: 'get',
